...
const defaultEnvVariables = [
    { key: 'ALIVE_IMG', value: 'https://files.catbox.moe/m7y8wj.png' },
    { key: 'PREFIX', value: '.' },
    ...
    { key: 'MOVIE_FOOTER', value: '> *lasith-md ᴍᴏᴠɪᴇꜱ 🍃*' },
    { key: 'BOT_NAME', value: 'lasith-MD' },
    { key: 'MENU_IMG', value: 'https://files.catbox.moe/pttjpm.jpeg' },
    { key: 'OWNER_REACT', value: 'true' },
    { key: 'FOOTER', value: '> *YOUR FOOTER ☣️*' },
    { key: 'ALIVE_MSG', value: 'ᴀʟɪᴠᴇ ɴᴏᴡ. . .' },
    { key: 'OWNER_NAME', value: 'LASITH DULSHAN ☣️' },
    { key: 'OWNER_EMOJI', value: '☣️' },
    { key: 'HEART_REACT', value: 'false' },
    { key: 'OWNER_NUMBER', value: '94774367639' }
];
